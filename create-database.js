...
async function createDatabase() {
  try {
    await sql`CREATE DATABASE albuns;`; 
...
async function create() {
  try {
    ...
    await sql`GRANT ALL PRIVILEGES ON DATABASE albuns TO local;`;
    ...
    console.error('Error creating albuns or granting privileges:', error.message);
  } finally {
    await sql.end();
  }
}
